      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center space-x-2 bg-gray-800/50 px-4 py-2 rounded-full mb-8 backdrop-blur-sm border border-white/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <button
                ...
                className="px-8 py-4 bg-white text-black rounded-lg font-semibold text-lg hover:bg-gray-200 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                Request Demo
              </button>
              <button
            ...
            <div className="flex flex-wrap justify-center gap-6">
              {trustBadges.map((badge) => (
                <div key={badge.label} className="flex items-center space-x-2 text-sm bg-white/10 px-4 py-2 rounded-lg backdrop-blur-sm border border-white/20">
                  <badge.icon className="text-white" size={18} />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-900 relative overflow-hidden">
              <div className="absolute top-0 right-0 bg-gray-900 text-white px-4 py-1 text-sm font-semibold rounded-bl-lg">
                Maximum Security
              </div>
              <div className="mt-4">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-200 relative overflow-hidden">
              <div className="absolute top-0 right-0 bg-gray-700 text-white px-4 py-1 text-sm font-semibold rounded-bl-lg">
                Managed Service
              </div>
              <div className="mt-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature) => (
              <div key={feature.title} className="text-center group">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gray-100 rounded-2xl mb-4 group-hover:bg-gray-900 transition-all duration-300">
                  <feature.icon className="text-gray-900 group-hover:text-white transition-colors" size={32} />
                </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join leading law firms that trust Magnius AI for secure, intelligent legal assistance
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              ...
              className="px-8 py-4 bg-white text-gray-900 rounded-lg font-semibold text-lg hover:bg-gray-50 transition-colors shadow-lg border-2 border-gray-900"
            >
